<template>
	<div class="content-header" id="payment-switch">
                        ...
                        <div class="bg-white corner-rounded p-3">
                            <div class="mb-3">
                                <div class="col-12 form-group">
                                    <label>Enable workshop payment?</label>
                                    <div>
...
export default {
	...
	methods: {
        ...
        getSchedule() {
            this.$store.dispatch("settings/payment-switch/getSettings")
            .then((res) => {
        ...
        save() {
            ...
            this.$store.dispatch("settings/payment-switch/update", this.form)
            .then(res => {
    ...
    mounted() {
		this.setNavbarTitle('Payment Switch')
