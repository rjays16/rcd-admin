<template>
	<div class="content-header" id="abstract-submission-switch">
                        ...
                        <div class="bg-white corner-rounded p-3">
                            <div class="mb-3">
                                <div class="col-12 form-group">
                                    <label>Enable abstract submission?</label>
                                    <div>
...
export default {
	...
	methods: {
        ...
        getSchedule() {
            this.$store.dispatch("settings/abstract-submission/getSettings")
            .then((res) => {
        ...
        save() {
            ...
            this.$store.dispatch("settings/abstract-submission/update", this.form)
            .then(res => {
    ...
    mounted() {
		this.setNavbarTitle('Abstract Submission Switch')
