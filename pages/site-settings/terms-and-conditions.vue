...
export default {
	...
	methods: {
        ...
        getTerms() {
            this.$store.dispatch("settings/terms-and-conditions/getTerms")
            .then((res) => {
                this.form = res.data
            })
            .catch((err) => {
        ...
        save() {
            ...
            this.$store.dispatch("settings/terms-and-conditions/update", form)
            .then(res => {
    ...
    mounted() {
		this.setNavbarTitle('Terms and Conditions')
