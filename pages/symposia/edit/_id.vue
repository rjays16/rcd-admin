<template>
	<div class="content-header" id="edit-symposia">
...
export default {
	...
	methods: {
        ...
        getSymposiaEvent() {
			this.$store.dispatch("symposia/getEvent", this.$route.params.id)
			.then(res => {
                this.form = res.data
			})
			.catch(err => {
        ...
        save() {
            ...
            this.$store.dispatch("symposia/updateEvent", this.form)
            .then(res => {
