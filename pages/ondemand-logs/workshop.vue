<template>
    <section id="ondemand-logs-workshop">
...
export default {
    ...
    methods: {        
        ...
        getAttendance() {
            this.$store.dispatch("ondemand-logs/getWorkshopLogs")
            .then(res => {
        ...
        exportData(){
            ...
            this.$store.dispatch("ondemand-logs/exportWorkshop")
            .then(res => {
                const url = URL.createObjectURL(new Blob([res.data]))
                const link = document.createElement('a')
                link.href = url
                link.setAttribute('download', "ondemand_workshop_logs.xlsx")
    ...
    mounted() {
        ...
        this.setNavbarSubpageTitle('Workshop')
        this.setNavbarIcon('')
