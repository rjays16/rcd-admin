<template>
    <section id="ondemand-logs-symposia">
...
export default {
    ...
    methods: {        
        ...
        getAttendance() {
            this.$store.dispatch("ondemand-logs/getSymposiaLogs")
            .then(res => {
        ...
        exportData(){
            ...
            this.$store.dispatch("ondemand-logs/exportSymposia")
            .then(res => {
                const url = URL.createObjectURL(new Blob([res.data]))
                const link = document.createElement('a')
                link.href = url
                link.setAttribute('download', "ondemand_symposia_logs.xlsx")
    ...
    mounted() {
        ...
        this.setNavbarSubpageTitle('Symposia')
        this.setNavbarIcon('')
