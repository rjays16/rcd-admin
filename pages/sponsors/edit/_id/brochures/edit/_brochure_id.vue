<template>
	<div class="content-header" id="edit-brochure">
...
export default {
	...
	data() {
		return {
            ...
            positionNumberOptions: this.$store.state.sponsor_assets.brochures.assetPositions,
		}
	},
    validations: {
        form: {
	...
	methods: {
        ...
        getBrochure() {
            let data = {
                ...
                brochure_id: this.$route.params.brochure_id,
            }
            this.$store.dispatch("sponsor_assets/brochures/getBrochure", data)
            .then(res => {
                let data = res.data
                this.form.id = this.form.sponsor_id = data.sponsor_id
                this.form.brochure_id = data.id
        ...
        save() {
            ...
            this.$store.dispatch("sponsor_assets/brochures/update", this.form)
            .then(res => {
