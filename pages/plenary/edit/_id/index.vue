<template>
	<div class="content-header" id="edit-plenary">
...
export default {
	...
	methods: {
        ...
        getPlenaryEvent() {
            this.$store.dispatch("plenaries/getPlenaryEvent", this.$route.params.id)
            .then((res) => {
                this.form = res.data
            })
            .catch((err) => {
        ...
        save() {
            ...
            this.$store.dispatch("plenaries/update", this.form)
            .then(res => {
