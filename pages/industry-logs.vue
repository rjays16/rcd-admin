<template>
    <section id="industry-lecture-logs">
...
export default {
    ...
    methods: {        
        ...
        getAttendance() {
            this.$store.dispatch("ondemand-logs/getIndustryLogs")
            .then(res => {
        ...
        exportData(){
            ...
            this.$store.dispatch("ondemand-logs/exportIndustry")
            .then(res => {
                const url = URL.createObjectURL(new Blob([res.data]))
                const link = document.createElement('a')
                link.href = url
                link.setAttribute('download', "industry_lecture_logs.xlsx")
    ...
    mounted() {
        this.setNavbarTitle('Industry Lecture Logs')
